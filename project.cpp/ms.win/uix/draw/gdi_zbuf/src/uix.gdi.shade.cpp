...
using eMode = CRectShader::e_mode;

CRectShader:: CRectShader (void) : m_mode(e_mode::e_horz) {}
...
const
TVertexSet&   CRectShader::Vertices (void) const { return this->m_vertices; }
TVertexSet&   CRectShader::Vertices (void)       { return this->m_vertices; }

eMode CRectShader::Mode (void) const { return this->m_mode; }
bool  CRectShader::Mode (const eMode _mode) {
...
TVertices     CRectShader::RawVertices (void) const {
	TVertices vertices;

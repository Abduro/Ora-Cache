/*
	Created by Tech_dog (ebontrop@gmail.com) on 03-May-2025 at 05:54:34.961, UTC+4, Batumi, Saturday;
	This is Ebo Pack DirectX device context vertex buffer wrapper interface implementation file; 
*/
#include "direct_x.buf.vertex.h"

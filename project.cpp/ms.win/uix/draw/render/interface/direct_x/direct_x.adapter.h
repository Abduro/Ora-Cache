...
namespace ex_ui { namespace draw { namespace direct_x {
	...
	// including so named 'Microsoft Basic Render Driver';
	...
	// https://learn.microsoft.com/en-us/windows/win32/api/dxgi/nn-dxgi-idxgifactory  (deprecated on Windows 8/8.1/10);
	...
	// https://learn.microsoft.com/en-us/windows/win32/api/dxgi1_4/nn-dxgi1_4-idxgifactory4 (enumerates adapters by LUID and adapters supporing WARP);
	// https://learn.microsoft.com/en-us/windows/win32/api/dxgi1_5/nn-dxgi1_5-idxgifactory5 (introduces checking feature support);
	// https://learn.microsoft.com/en-us/windows/win32/api/dxgi1_6/nn-dxgi1_6-idxgifactory6 (introduces enumerating adapters based on a given GPU preference);
	class CAdapter_Enum
	{
	public:
		 CAdapter_Enum (void);

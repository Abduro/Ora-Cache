...
namespace ebo { namespace boo { namespace test { namespace open_gl { namespace draw {
	...
	class CFake_renderer {
	public:
		CFake_renderer (void); CFake_renderer (const CFake_renderer&) = delete; CFake_renderer (CFake_renderer&&) = delete; ~CFake_renderer (void) = default;

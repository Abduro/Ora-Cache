#ifndef _OPEN_GL_TUTOR_3_MODULE_H_INCLUDED
#define _OPEN_GL_TUTOR_3_MODULE_H_INCLUDED
/*
	...
	-----------------------------------------------------------------------------
	Adopted to OpenGL camera tutorial module om 27-Nov-2025 at 01:32:11.109, UTC+4, Batumi, Thursday;
*/
#include "gl_defs.h"              // has the reference to OpenGL32.lib;
#include "open_gl_tutor.3.wnd.h"  // this is the target window class interface;
...
namespace ex_ui { namespace draw { namespace open_gl {  namespace camera {
	...
	class CCameraModule : public ATL::CAtlExeModuleT<CCameraModule> { typedef ATL::CAtlExeModuleT<CCameraModule> TModule;
	public:
...
#pragma comment(lib, "gl.shared_v15.lib")     // open_gl tutorials shared lib; it is required for usage of camera API;
#pragma comment(lib, "gl.tutor.3.camera.lib") // this tutorial project static library;

...
static _pc_sz prog_fun_names[] = {
	_T("glCreateProgram"), _T("glDeleteProgram"), _T("glGetAttribLocation"), _T("glGetProgramInfoLog"), _T("glGetProgramiv"),
	_T("glUseProgram"), _T("glValidateProgram"),
};

enum class e_prog_fun_ndx : uint32_t {
	e_att_loc = 0x2, e_create = 0x0, e_delete = 0x1, e_info_log = 0x3, e_params = 0x4, e_use = 0x5, e_valid = 0x6,
};

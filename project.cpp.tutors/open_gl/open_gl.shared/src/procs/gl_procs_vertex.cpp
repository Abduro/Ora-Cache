...
static _pc_sz attr_fun_names[] = {
	_T("glDisableVertexArrayAttrib"), _T("glEnableVertexArrayAttrib"), _T("glGetAttribLocation"), _T("glBindAttribLocation")
};
enum class e_attr_fun_ndx : uint32_t {
	e_disable = 0x0, e_enable = 0x1, e_get_ndx = 0x2, e_set_ndx = 0x3
};
